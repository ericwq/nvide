...
#
RUN apk add --no-cache --update py3-pip py3-pynvim py3-wheel npm clang-dev cppcheck ninja bash unzip cmake readline-dev lua5.3-dev autoconf automake bear waf
